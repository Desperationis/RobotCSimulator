...
// [SECTION] Example App: Custom Drawable using ImDrawList API / ShowExampleAppCustomDrawable()
...
static void ShowExampleAppCustomDrawable(bool* p_open);
...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    if (show_app_custom_rendering)    ShowExampleAppCustomDrawable(&show_app_custom_rendering);
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Selectables"))
    {
        ...
        if (ImGui::TreeNode("Drawable more text into the same line"))
        {
